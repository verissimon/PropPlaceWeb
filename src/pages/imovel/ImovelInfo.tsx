    ...
    <>
      ...
      <div className="mt-32 w-[95%] grid justify-self-center">
        <span className="justify-self-end">
          <Usuario id={''} nome={'Mari'} />
        </span>
      </div>

      <div className="w-[80%] my-8 justify-self-center flex gap-14">
        <img className="w-2/6 h-auto" src={imovel.imagem} />
        <div className="flex overflow-x-auto shrink-0 gap-4">
          <img className="w-20 h-auto" src={imovel.imagem} />
          <img className="w-20 h-auto" src={imovel.imagem} />
          <img className="w-20 h-auto" src={imovel.imagem} />
          <img className="w-20 h-auto" src={imovel.imagem} />
          <img className="w-20 h-auto" src={imovel.imagem} />
      ...
      >
        ...
        <div className="min-w-80 grow-6 flex flex-col gap-10">
          <div className="w-full flex-1 relative">
            <Mapa />
            {/* colocar ver no mapa acima do mapa */}
